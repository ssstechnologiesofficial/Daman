          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              <div className="flex flex-col ml-4"> 
                ...
                <p className="text-white text-base">1</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              <div className="flex flex-col ml-4"> 
                ...
                <p className="text-white text-base">3</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full"> {/* Reduced padding */}
              ...
              <div className="flex flex-col ml-4"> {/* Flex container for vertical alignment */}
                ...
                <p className="text-white text-base">4</p> {/* Reduced text size */}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              <div className="flex flex-col ml-4"> 
                ...
                <p className="text-white text-base">6</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              <div className="flex flex-col ml-4"> 
                ...
                <p className="text-white text-base">7</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full"> {/* Reduced padding */}
              ...
              <div className="flex flex-col ml-4"> {/* Flex container for vertical alignment */}
                ...
                <p className="text-white text-base">8</p> {/* Reduced text size */}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              <div className="flex flex-col ml-4"> 
                ...
                <p className="text-white text-base">9</p>
              </div>
            </div>
          </div>
