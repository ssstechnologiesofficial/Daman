...
const ThirtySec = () => {
  return (
    <div className="w-full p-2 flex-col">
        ...
        <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 justify-start">
          ...
          <div className="flex items-center  cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              {/* Reduced padding */}
              <div
                className="bg-red-500 flex items-center justify-center rounded shadow-lg"
              ...
              <div className="flex flex-col ml-4">
                ...
                <p className="text-white text-base">Join Red</p>{" "}
                {/* Reduced text size */}
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                className="bg-violet-600 flex items-center justify-center rounded shadow-lg"
                style={{ width: "55px", height: "50px" }}
              >
                <FaShoppingCart className="text-white text-2xl" />
              </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                className="bg-green-600 flex items-center justify-center rounded shadow-lg"
                style={{ width: "55px", height: "50px" }}
              >
                <FaShoppingCart className="text-white text-2xl" />
              </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                className="bg-cyan-500  flex items-center justify-center rounded shadow-lg"
                style={{ width: "55px", height: "50px" }}
              >
                <FaShoppingCart className="text-white text-2xl" />
              </div>
      ...
      <div className="w-full p-2 ">
        {/* Wrapper div added */}
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 justify-start">
          {/* Increased gap for cards */}
          {/* Card 30sec */}
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              {/* Reduced padding */}
              <div
                className="bg-customBlue flex items-center justify-center rounded shadow-lg"
                style={{ width: "55px", height: "50px" }}
              >
                {" "}
                {/* Reduced icon size */}
              ...
              <div className="flex flex-col ml-4">
                {" "}
                {/* Flex container for vertical alignment */}
                <p className="text-white text-base">Join 0</p>{" "}
                {/* Reduced text size */}
                <p className="text-white text-base">0</p>{" "}
                {/* Reduced text size */}
              </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                ...
                style={{ width: "55px", height: "50px" }}
              >
                <h2 className="text-white text-2xl font-semibold">1</h2>
              </div>
              <div className="flex flex-col ml-4">
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              >
                {" "}
                {/* Reduced icon size */}
                <h2 className="text-white text-2xl font-semibold">4</h2>{" "}
                {/* Reduced icon size */}
              </div>
              <div className="flex flex-col ml-4">
                {" "}
                {/* Flex container for vertical alignment */}
                <p className="text-white text-base">Join 4</p>{" "}
                {/* Reduced text size */}
                <p className="text-white text-base">0</p>{" "}
                {/* Reduced text size */}
              </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                ...
                style={{ width: "55px", height: "50px" }}
              >
                <h2 className="text-white text-2xl font-semibold">6</h2>
              </div>
              <div className="flex flex-col ml-4">
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                ...
                style={{ width: "55px", height: "50px" }}
              >
                <h2 className="text-white text-2xl font-semibold">7</h2>
              </div>
              <div className="flex flex-col ml-4">
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              ...
              >
                {" "}
                {/* Reduced icon size */}
                <h2 className=" text-white text-2xl font-semibold">8</h2>{" "}
                {/* Reduced icon size */}
              </div>
              <div className="flex flex-col ml-4">
                {" "}
                {/* Flex container for vertical alignment */}
                <p className="text-white text-base">Join 8</p>{" "}
                {/* Reduced text size */}
                <p className="text-white text-base">0</p>{" "}
                {/* Reduced text size */}
              </div>
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                ...
                style={{ width: "55px", height: "50px" }}
              >
                <h2 className="text-white text-2xl font-semibold">9</h2>
              </div>
              <div className="flex flex-col ml-4">
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                ...
                style={{ width: "55px", height: "50px" }}
              >
                <h2 className="text-white text-2xl font-semibold">B</h2>
              </div>
              <div className="flex flex-col ml-4">
          ...
          <div className="flex items-center cursor-pointer w-full">
            <div className="bg-darkSidebar shadow-custom p-4 rounded flex items-center w-full">
              <div
                ...
                style={{ width: "55px", height: "50px" }}
              >
                <h2 className="text-white text-2xl font-semibold">S</h2>
              </div>
              <div className="flex flex-col ml-4">
